...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x709";
}
}
"  s0  " -> "0x786" [style = solid];
"  s1  " -> "0x788" [style = solid];
"  s2  " -> "0x78a" [style = solid];
"  c3  " -> "0x78b" [style = solid];
"0x78a" -> "0x789";
"0x78a" -> "0x789" [style = dotted];
"0x78b" -> "0x710";
"0x78b" -> "0x789" [style = dashed];
"0x710" -> "0x709";
"0x710" -> "0x709" [style = dotted];
"0x788" -> "0x787";
"0x788" -> "0x787" [style = dotted];
"0x789" -> "0x742";
"0x789" -> "0x787" [style = dashed];
"0x742" -> "0x709";
"0x742" -> "0x709" [style = dotted];
"0x787" -> "0x761";
"0x787" -> "0x785" [style = dashed];
"0x786" -> "0x785";
"0x786" -> "0x785" [style = dotted];
"0x761" -> "0x709";
"0x761" -> "0x709" [style = dotted];
"0x785" -> "0x709";
"0x785" -> "0x709" [style = dotted];
"0x709" [label = "1"];
}
...
Caught: Timeout expired.  Lag = 199 ms.
