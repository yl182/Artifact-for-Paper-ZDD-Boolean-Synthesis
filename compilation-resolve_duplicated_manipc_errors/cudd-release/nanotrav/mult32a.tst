...
Number of cache collisions: 1299
Number of cache deletions: 21071
Cache used slots = 17.82% (expected 10.53%)
Soft limit for cache size: 100352
Number of buckets in unique table: 25088
Used buckets in unique table: 12.44% (expected 12.44%)
...
Maximum resident size            =  4744K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1755
Swaps = 0
Input blocks = 0
Output blocks = 0
